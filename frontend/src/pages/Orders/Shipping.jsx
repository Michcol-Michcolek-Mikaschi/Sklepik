    ...
    <div className="container mx-auto mt-10">
      ...
      <div className="mt-[10rem] flex justify-around items-center flex-wrap">
        <form onSubmit={submitHandler} className="w-[40rem]">
          <h1 className="text-2xl font-semibold mb-4">Wysyłka</h1>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="block text-gray-400">Wybierz metodę</label>
            <div className="mt-2">
              <label className="inline-flex items-center">
                ...
                <span className="ml-2">PayPal lub karta kredytowa</span>
              </label>
            </div>
          </div>
