...
const ProductList = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.error) {
        toast.error("Tworzenie produktu nie powiodło się. Spróbuj ponownie.");
      } else {
        toast.success(`${data.name} jest tworzone`);
        navigate("/");
      }
    } catch (error) {
      console.error(error);
    ...
    <div className="container xl:mx-[9rem] sm:mx-[0]">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-3/4 p-3">
          <div className="h-12">Utwórz produkt</div>
          ...
          <div className="mb-3">
            <label className="border text-white px-4 block w-full text-center rounded-lg cursor-pointer font-bold py-11">
              {image ? image.name : "Załaduj obrazek"}
